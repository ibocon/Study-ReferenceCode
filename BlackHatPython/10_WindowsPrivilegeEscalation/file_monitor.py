# inject hacker's code into the file before the process executes it and then ultimately deletes it.

# Use Windows's API call ('ReadDirectoryChangesW')
# 'ReadDirectoryChangesW' enables hacker to monitor a directory for any changes to files or subdirectories.
        ...
        try:
            ...
            for action, file_name in results:
                ...
                if action == FILE_CREATED:
                    ...
                    # if target extension exist, start code injection
