# add some basic intelligence to look for keystrokes, mouse-clicks, and double-clicks.
# also try to determine if the sandbox operator is sending input repeatedly
# in order to try to respond to rudimentary sandbox detection methods.
# and, compare the last time a user interacted with the machine
