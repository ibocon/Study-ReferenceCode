...
namespace Archiva.Space
{
    class Hallway : Room
    {
        public Hallway(Data.Size size, Dictionary<Model.ModelType, Dictionary<string, string>> materials, Dictionary<StaticCompType, string> staticComp) : base(size, materials, staticComp)
        {
        ...
        {
            Hallway clone = new Hallway(Size, Materials, StaticComponents);
