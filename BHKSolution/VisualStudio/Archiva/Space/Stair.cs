...
namespace Archiva.Space
{
    class Stair : Room
    {
        public Stair(Data.Size size, Dictionary<Model.ModelType, Dictionary<string, string>> materials, Dictionary<StaticCompType, string> staticComp) : base(size, materials, staticComp)
        {
        ...
        {
            Stair clone = new Stair(Size, Materials, StaticComponents);
